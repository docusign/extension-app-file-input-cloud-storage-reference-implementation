...
variable "application_name" {
  ...
  type        = string
  nullable    = false
  default     = "ext-app-file-input-cloud-storage"
...
variable "application_build_labels" {
  ...
  default = {
    ...
    "org.opencontainers.image.source"      = "https://github.com/docusign/extension-app-file-input-cloud-storage-reference-implementation"
